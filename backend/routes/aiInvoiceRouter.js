...
if(!API_KEY) {
    console.warn("No Gemini Key found in .env");
...
//in the prompt u can provide these details and it will fill those automatically
...
//it will try a  few common possibilities in order  
